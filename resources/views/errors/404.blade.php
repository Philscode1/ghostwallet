...
@keyframes flicker4{
  0%  {color: #f38000;text-shadow:0px 0px 4px #f38000;}
  30% {color: #f38000;text-shadow:0px 0px 4px #f38000;}
  31% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  32% {color: #f38000;text-shadow:0px 0px 4px #f38000;}
  36% {color: #f38000;text-shadow:0px 0px 4px #f38000;}
  37% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  41% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  42% {color: #f38000;text-shadow:0px 0px 4px #f38000;}
  85% {color: #f38000;text-shadow:0px 0px 4px #f38000;}
  86% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  95% {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  96% {color: #f38000;text-shadow:0px 0px 4px #f38000;}
  100%{color: #f38000;text-shadow:0px 0px 4px #f38000;}
}

@keyframes fadeInText{
  1%  {color: #12000a;text-shadow:0px 0px 4px #12000a;}
  70% {color: #f38000;text-shadow:0px 0px 14px #f38000;}
  100%{color: #f38000;text-shadow:0px 0px 4px #f38000;}
}
